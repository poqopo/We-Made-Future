...
interface IMasterChef {
  ...
  function pendingWe_Made_Future(address _stakeToken, address _user) external view returns (uint256);
  ...
  function depositWe_Made_Future(address _for, uint256 _amount) external;

  function withdrawWe_Made_Future(address _for, uint256 _amount) external;
